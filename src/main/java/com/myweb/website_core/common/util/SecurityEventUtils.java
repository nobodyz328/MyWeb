...
public class SecurityEventUtils {
    ...
    public static SecurityEventRequest createAccessDeniedEvent(String resource, String action) {
        return SecurityEventRequest.builder()
                ...
                .title("未授权访问尝试")
                .description(String.format("尝试未授权访问资源：%s，操作：%s", resource, action))
    ...
    public static SecurityEventRequest createMaliciousFileUploadEvent(String filename, String reason) {
        return SecurityEventRequest.builder()
                ...
                .title("恶意文件上传尝试")
                .description(String.format("尝试上传恶意文件：%s，原因：%s",filename, reason))
    ...
    public static SecurityEventRequest createPrivilegeEscalationEvent(String targetRole, String currentRole) {
        return SecurityEventRequest.builder()
                ...
                .title("权限提升尝试")
                .description(String.format("尝试从角色 %s 提升到角色 %s",currentRole, targetRole))
